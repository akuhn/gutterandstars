...
%The model of LDA assumes that topic and documents follow a multinomial distribution, thus their approach is statistically more sound than LSI.
...
%\matter{write more, write results, compare to our results}
...
%\matter{Explain why we didn't use ten-fold cross validation which is normally commonly used (see also \cite{Anvi06a}) }
