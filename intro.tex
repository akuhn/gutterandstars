...
% --> include.tex
\item[\autoref{the chapter on the MSR user study}] presents a user study that looks at how developers find answers to technical questions and discusses code orientation by cognitive clues. The work presented in this chapter has been done in collaboration with Robert DeLine while interning at Microsoft research.
