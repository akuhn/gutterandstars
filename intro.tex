...
Examples of \codenavigation clues are 
	...
	sometimes even spatial clues like recalling that a piece of coude is located at the end of a text file. 
...
\begin{figure}
\begin{center}
  \includegraphics[width=0.75\linewidth]{intro-codemap-example}
\end{center}
...
\begin{figure*}
\begin{center}
  \includegraphics[width=\linewidth]{intro-pipeline}
\end{center}
