...
This chapter is based on our previous work, in which we first proposed semantic clustering \cite{Kuhn05a}. The main contributions of the current chapter are:
\begin{itemize}
...
\begin{figure}[h]
    \centering
  \includegraphics[width=\columnwidth]{fig/hapax-hotspot}
...
\begin{figure}[b]
  \centering
  \includegraphics[width=\columnwidth]{fig/hapax-jedit-correlation-zone}\\
